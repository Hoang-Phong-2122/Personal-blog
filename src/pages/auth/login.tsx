...
import {
    ...
    FormControl,
    InputLabel,
    OutlinedInput, IconButton, Link, FormHelperText
} from "@mui/material";
...
const Login = () => {
    ...
    const onLogin = async () => {
        ...
        if (u == "" || p == "") {
            ...
            _setError({username: u && "Vui lòng nhập username!", password: p && "Vui lòng nhập password!"});
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Box sx={{marginBottom: 8, display: 'flex', alignItems: 'center', flexWrap: 'wrap'}}>
                ...
                <Box>
                    ...
                    <Typography className="margin-y" sx={{fontSize: 15, fontWeight: 600, my: 1}}>Đăng nhập tài
                        khoản</Typography>
                    <TextField
                        sx={{my: 1}}
                        label="Tên tài khoản"
                        ...
                        value={username}
                        InputProps={{
                            startAdornment: <InputAdornment position="start"><MailOutline
                                sx={{color: 'grey'}}/></InputAdornment>,
                        }}
                    />
                    <TextField
                        sx={{my: 1}}
                        ...
                        value={password}
                        InputProps={{
                            startAdornment: <InputAdornment position="start"><Lock
                                sx={{color: 'grey'}}/></InputAdornment>,
                        }}
                    />
                    {error.login && (
                    ...
                    >Tiếp tục</Button>
                    <Typography
                        sx={{fontSize: 14, fontWeight: 400, my: 1}}
                    >Bạn chưa có tài khoản? <Link href="#" sx={{color: 'black', fontWeight: 500}}>Đăng
                        ký</Link></Typography>
                </Box>
            </Box>
        </Box>
